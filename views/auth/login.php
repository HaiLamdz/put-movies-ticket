                        ...
                        <form class="md-float-material" method="POST" >
                            <div class="auth-box">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                ...
                                                <span class="text-inverse">Bạn chưa có tài khoản??<a href="<?= BASE_URL . '?act=signUp' ?>">Đăng Ký</a></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit"  class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Login now.</button>
                                    </div>
                                </div>
                            </div>
                        </form>
